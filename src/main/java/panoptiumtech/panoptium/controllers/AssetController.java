...
public class AssetController {
    ...
    public String addAsset(@AuthenticationPrincipal AccountDetails accountDetails,
        ...
        return assetService.addAsset(assetDto.getName(),assetDto.getType(),assetDto.getColor(),accountDetails);
    }

    @PostMapping("/edit")
    public String editAsset(@AuthenticationPrincipal AccountDetails accountDetails,
                              @RequestBody AssetDTO assetDto) {
        return assetService.updateAsset(assetDto.getName(),assetDto.getType(),assetDto.getColor(),accountDetails);
    }
